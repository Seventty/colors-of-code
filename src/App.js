  ...
  return (
    <>
      <div>
        ...
        <footer style={{color: "white", background: "black", fontSize: 12, fontFamily: "Nunito", textAlign: "center"}}>Copyright @ Honil Cristina Barinas Núñez, Rainiery Valerio Gonzalez (SoftDevs) - 2021. Todas las ilustraciones mostradas en la galería son de autoría propia, cualquier reproducción ilegal de este contenido resultará en acciones legales inmediatas.</footer>
        <Navbar/>
      </div>
    </>
  )
