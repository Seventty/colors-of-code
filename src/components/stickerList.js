...
const epicos = [
    { id: 1, name: "Scaly Python", description: "Agrega un nuevo pigmento a tus lineas de programación.", image: "https://i.ibb.co/rGzpRRz/Python-Epico.webp", rate: "Medianamente probable"},
    ...
    { id: 4, name: "CSharp Royal Throne", description: "Conocido como: 'El padre del todo', observa a los otros lenguajes de programación desde su trono.", image: "https://i.ibb.co/mbDwZpB/CEpico.webp", rate: "Muy raro"},
    { id: 5, name: "Java Interestelar", description: "Nacido a partir de la gran explosión que expandió el cosmos de la programación.", image: "https://i.ibb.co/SsvWkNj/Java-Epico.webp", rate: "Muy probable"},
    { id: 6, name: "Clock Vim", description: "No es más que los engranajes de tu propio destino; Tu agregas, tu quitas.", image: "https://i.ibb.co/Tw5VZBC/VimEpico.webp", rate: "Muy probable"},
    ...
    { id: 8, name: "Bonfire FireBase", description: "Adelante, aventurero. Descansa tus dedos en la cálida fogata de tu propia biblioteca.", image: "https://i.ibb.co/hHCMzJf/Firebase-Epico.webp", rate: "Medianamente probable"},
    { id: 9, name: "Styled Ubuntu", description: "¿Listos? ¡Acción!", image: "https://i.ibb.co/LggM9Vs/Ubuntu-Epico.webp", rate: "Muy probable"},
];
...
const miticos = [
    ...
    { id: 2, name: "Royal CSS", description: "El emblema legendario usado por todos los miembros de la realeza que dieron sus vidas por el reino de CSS desde la construcción del mismo. Sirviendo como la colorida defensa del reino de la web", image: "https://i.ibb.co/zxMJ64W/CSSMitico.webp", rate: "Medianamente probable"},
    ...
    { id: 4, name: "Docker Smoothie", description: "Descubierto a partir de las ruinas gélidas de algún templo sumergido en la historia de la programación, se extrajo la escencia de Docker. Un batido que cuenta con todo el poder de la Contenerización y los diversos sabores que se ocultan tras sus contenedores.", image: "https://i.ibb.co/cD6kH60/Docker-Mitico.webp",  rate: "Muy raro"},
    { id: 5, name: "Horizonte Windows", description: "Donde se reune una masiva cantida de usuarios en busqueda de la promesa de la libertad y evolución.", image: "https://i.ibb.co/F6WC56k/Windows-Mitico.webp", rate: "Muy probable"},
...
const gloriaMitica = [
    {id: 1, name: "Vue 🍃", description: "Forjado en los manglares más profundos de la selva Amazónica, alimentado desde los inicios por las ramas que unifica al mundo.", image: "https://i.ibb.co/6rB5KVb/WtaC3H6.png"},
    {id: 2, name: "Angular 🔥", description: "Forjado bajo el ígneo e infernal magma del volcan Puhahonu, comprimido hasta ser un mineral casi perfecto.", image: "https://i.ibb.co/6rB5KVb/WtaC3H6.png"},
    {id: 3, name: "React 🌊", description: "Forjado en el abismo más profundo de la fosa de las Marianas, sometido a presiones abismales hasta ser transmutado como diamante por la presión de su entorno. Un lugar a donde no llega la luz...", image: "https://i.ibb.co/6rB5KVb/WtaC3H6.png"},
];
